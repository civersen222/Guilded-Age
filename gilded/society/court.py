"""Council seats (Gilded spec 4): Board Chairman, Chief Engineer, Head of Security, Master of the Press, Foreign Secretary, Marshal."""
...
class Court:
    ...
    POSITION_STATS: Dict[CourtPosition, str] = {
        CourtPosition.BOARD_CHAIRMAN: "industry",
        CourtPosition.CHIEF_ENGINEER: "science",
        CourtPosition.HEAD_OF_SECURITY: "intrigue",
        CourtPosition.MASTER_OF_PRESS: "statecraft",
        CourtPosition.FOREIGN_SECRETARY: "statecraft",
    ...
    def status_report(self) -> str:
        lines = [f"=== Court of {self.ruler.name} ({self.filled_count}/6 filled) ==="]
