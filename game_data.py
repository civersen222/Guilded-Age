...
CIVILIZATIONS = {
    ...
    "Mesopotamia": Civilization("Mesopotamia", "Chariot", "", "+1 food from Plains tiles", "Monarchy", ["Agriculture", "Animal Husbandry"], "wheat", 120, 40, 20, {"diplomacy": 10, "martial": 11, "stewardship": 12, "intrigue": 7}, ["Industrious", "Diplomat"]),
    "Egypt": Civilization("Egypt", "", "Pyramid", "Wonders cost 20% less", "Theocracy", ["Astronomy", "Masonry"], "gold", 90, 60, 40, {"diplomacy": 11, "martial": 10, "stewardship": 9, "intrigue": 10}, ["Charismatic", "Magnanimous"]),
    "Persia": Civilization("Persia", "", "Satrap", "+1 gold from every resource", "Monarchy", ["Coinage", "Feudalism"], "purple", 110, 50, 30, {"diplomacy": 12, "martial": 9, "stewardship": 11, "intrigue": 8}, ["Diplomat", "Cunning"]),
    ...
    "Mongol": Civilization("Mongol", "", "", "+2 movement for cavalry units", "Custom", ["Animal Husbandry", "Chivalry"], "brown", 70, 30, 15, {"diplomacy": 8, "martial": 14, "stewardship": 7, "intrigue": 11}, ["Warrior", "Brave"]),
    "Viking": Civilization("Viking", "", "Longhouse", "Coastal tiles provide +1 production", "Custom", ["Navigation", "Astronomy"], "silver", 95, 45, 20, {"diplomacy": 9, "martial": 13, "stewardship": 8, "intrigue": 10}, ["Warrior", "Opportunistic"]),
    "India": Civilization("India", "", "", "+1 faith from all tiles", "Theocracy", ["Theology", "Philosophy"], "saffron", 100, 60, 50, {"diplomacy": 12, "martial": 8, "stewardship": 11, "intrigue": 9}, ["Charismatic", "Magnanimous"]),
    "Byzantium": Civilization("Byzantium", "", "Hypodrome", "+1 gold and +1 science from cities", "Oligarchy", ["Mathematics", "Coinage"], "navy", 115, 70, 35, {"diplomacy": 11, "martial": 10, "stewardship": 12, "intrigue": 7}, ["Scholar", "Diplomat"]),
